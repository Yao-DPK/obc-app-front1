...
const navItems: NavItem[] = [
  ...
  { to: '/super-admin/users', label: 'Gestion Utilisateurs', icon: File, roles: ['super_admin'], section: 'gestion' },  
  ...
  // Section Joueur
  { to: '/player/documents', label: 'Documents', icon: FileText, roles: ['player'], section: 'gestion' },
  { to: '/player/payments', label: 'Paiements', icon: CreditCard, roles: ['player'], section: 'gestion' },
   ,
