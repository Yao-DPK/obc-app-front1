// src/components/dashboard/PlayerOverview.tsx
...
export function PlayerOverview({ userId, isPlayer }: PlayerOverviewProps) {
  const {
    user,
    isLoading,
    isPhotoLoading,
    ...
    >
        ...
        <Card className="border-red-200 bg-red-50/50">
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <Button variant="destructive" size="sm" className="ml-auto flex-shrink-0" asChild>
              <Link to={isPlayer ? `/player/payments/`: `payments`}>Voir</Link>
            </Button>
          </CardContent>
        </Card>
      )}
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex items-center gap-6 mb-6">
            <div className="relative h-28 w-36 rounded-lg overflow-hidden border-2 border-primary/20 bg-gray-100 flex-shrink-0">
              {isPhotoLoading ? (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button variant="ghost" size="sm" asChild>
            <Link to={isPlayer ? `/player/payments/`: `payments`}>
              Voir tous
              <ChevronRight className="h-4 w-4 ml-1" />
            </Link>
          </Button>
